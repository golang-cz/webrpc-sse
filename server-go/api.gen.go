...
func WebRPCSchemaHash() string {
	return "a53b3b444366958a0362df8e6fe2a251ac51cb18"
}
...
func (s *chatbotServer) serveSendMessageJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	reqContent := struct {
		Arg0 string `json:"author"`
		Arg1 string `json:"msg"`
	}{}
	...
	func() {
		...
		ret0, err = s.Chatbot.SendMessage(ctx, reqContent.Arg0, reqContent.Arg1)
	}()
	respContent := struct {
