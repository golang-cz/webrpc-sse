// webrpc-sse v1.0.0 d6f9f65c4e6679fe5f8b3c90bce102d28d20c755
// --
...
func WebRPCSchemaHash() string {
	return "d6f9f65c4e6679fe5f8b3c90bce102d28d20c755"
}
...
type Chatbot interface {
	...
	SubscribeMessages(ctx context.Context, q string) ([]string, error)
}
...
func (s *chatbotServer) serveSendMessage(ctx context.Context, w http.ResponseWriter, r *http.Request) {
...
func (s *chatbotServer) serveSendMessageJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		err = s.Chatbot.SendMessage(ctx, reqContent.Arg0)
	}()
...
func (s *chatbotServer) serveSubscribeMessages(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *chatbotServer) serveSubscribeMessagesJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.Chatbot.SubscribeMessages(ctx, reqContent.Arg0)
	}()
	respContent := struct {
		Ret0 []string `json:"msgs"`
	}{ret0}
